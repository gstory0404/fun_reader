          ...
          builder: (controller) {
            return StatusWidget(
                ...
                body: Stack(
                  children: [
                    Obx(() => Container(
                          color: controller.readPhoneCtr.bgColorList[
                              controller.readPhoneCtr.bgColor.value],
                          child: Column(
                            children: [
                              Container(
                                ...
                                child: Container(
                                  child: Obx(
                                    () => ScrollablePositionedList.builder(
                                      itemCount:
                                          controller.chapterContentList.length,
                                      physics: const BouncingScrollPhysics(),
                                      itemBuilder: (context, index) =>
                                          ReadPhoneItem(
                                        chapter: controller
                                            .chapterContentList[index],
                                      ),
                              ...
                              Container(
                                padding: EdgeInsets.symmetric(
                                    horizontal:
                                        controller.readPhoneCtr.widthMarginList[
                                            controller.readPhoneCtr.widthMargin
                                                .value],
                                    vertical: 4),
                                child: Row(
                                  mainAxisAlignment:
                                  ...
                                  children: [
                                    Obx(() => Text(
                                          ...
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontFamily: controller.readPhoneCtr
                                                    .fontFamilyList[
                                                controller.readPhoneCtr
                                                    .fontFamily.value],
                                            color: controller
                                                    .readPhoneCtr.fontColorList[
                                                controller.readPhoneCtr
