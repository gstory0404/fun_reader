...
class FindPhoneItem extends StatefulWidget {
  RuleBean ruleBean;

  FindPhoneItem({Key? key, required this.ruleBean}) : super(key: key);

  @override
  State<FindPhoneItem> createState() => _FindItemState();
}

class _FindItemState extends State<FindPhoneItem> {
  bool isShow = false;
